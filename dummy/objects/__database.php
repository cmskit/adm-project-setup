...
/**
* register autoload for ORM classes (ignoring other classes)
* @var string $class class name
*/
spl_autoload_register(function ($class)
{
	$a = explode('\\', $class);
	if (isset($a[1]) && $a[0] === __NAMESPACE__)
	{
		include __DIR__ . '/class.' . strtolower($a[1]) . '.php';
	}
});

/**
* access this object just via ###PROJECTNAME###\DB::instance([$index])
* 
* @access   public
*/
class DB
